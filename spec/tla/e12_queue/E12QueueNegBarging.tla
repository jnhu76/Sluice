------------------------------- MODULE E12QueueNegBarging -------------------------------
(*
  NEG-QUEUE-3: Barging. FastPushCommit drops the ProdEligibleSet = {} guard, allowing a newcomer producer to fast-commit over an older eligible producer waiter.
  Single-rule difference from E12Queue: the ONLY defect is in FastPushCommit.
  Expected first invariant violation: NoBarging.
*)
