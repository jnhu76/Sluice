------------------------------- MODULE E12QueueNegMoveNotEmptied -------------------------------
(*
  NEG-QUEUE-2: MoveNotEmptied. ProducerGrantCommit moves producerOp->ring but leaves prodItem[p] = it (source operation not emptied); the item is claimed by both the ring and the producer operation.
  Single-rule difference from E12Queue: the ONLY defect is in ProducerGrantCommit.
  Expected first invariant violation: UniqueItemOwner.
*)
