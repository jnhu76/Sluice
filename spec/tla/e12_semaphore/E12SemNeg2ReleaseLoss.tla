------------------------------- MODULE E12SemNeg2ReleaseLoss -------------------------------
(*
  NEG-SEM-2: ReleaseLoss. ReleaseTransfer increments acceptedReleaseCount but drops acquiredCount++ (the grant permit is lost).
  Single-rule difference from E12Semaphore: the ONLY defect is in ReleaseTransfer.
  Expected first invariant violation: InvPermitConservation.
*)
