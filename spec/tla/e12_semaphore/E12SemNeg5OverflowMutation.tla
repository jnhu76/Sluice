------------------------------- MODULE E12SemNeg5OverflowMutation -------------------------------
(*
  NEG-SEM-5: OverflowMutation. ReleaseOverflow mutates available++ instead of leaving it unchanged.
  Single-rule difference from E12Semaphore: the ONLY defect is in ReleaseOverflow.
  Expected first invariant violation: InvOverflowNonMutation.
*)
