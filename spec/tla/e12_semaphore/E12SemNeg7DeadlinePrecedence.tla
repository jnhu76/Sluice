------------------------------- MODULE E12SemNeg7DeadlinePrecedence -------------------------------
(*
  NEG-SEM-7: DeadlinePrecedence. AcquireUntilImmediate latches admissionSawPermit+admissionSawDue but resolves Expired instead of Woken (deadline beats an admissible permit).
  Single-rule difference from E12Semaphore: the ONLY defect is in AcquireUntilImmediate.
  Expected first invariant violation: InvPermitFirstDeadline.
*)
