...
std::string_view to_string(UnsupportedStrategyPolicy policy) {
    switch (policy) {
    case UnsupportedStrategyPolicy::ReturnInvalidState:
        return "return_invalid_state";
    case UnsupportedStrategyPolicy::FallbackToAuto:
        return "fallback_to_auto";
    }
    return "unknown";
}
