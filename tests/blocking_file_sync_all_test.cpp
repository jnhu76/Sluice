...
using sluice::Result;
using sluice::blocking::sync_all;
...
std::string make_temp_file(const std::string& content) {
    char path[] = "/tmp/sluice_blocking_file_sync_all_XXXXXX";
...
int main() {
    ...
    std::printf("all %zu blocking file sync all tests passed\n", sizeof(tests) / sizeof(tests[0]));
    return 0;
}
