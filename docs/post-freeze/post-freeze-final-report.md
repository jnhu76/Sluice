...
| File | Lines | Domain |
|---|---|---|
| `src/async/scheduler_park_wake.cpp` | 1153 | park/wake, R1-R4 protocol, interrupt bridge |
...
| `src/async/scheduler.cpp` | 1975 | kept: ctor/dtor, worker loop, steal, spawn/run, classification |
