...
**Status: SLUICE-CORE-014B.** Checklist for tagging the blocking sluice-core MVP
...
```bash
git tag -a v0.1-mvp -m "sluice-core v0.1-mvp: blocking measurable Zig-inspired I/O core"
