...
| `ContractDestroyOperation` after Aborted | `~SelectGroup()` / frame unwind | `admitted_ && phase==Aborted` | frame destruction | n/a | accepted by destructor (phase Consumed or Aborted) | P7-T6, destruction closure |
