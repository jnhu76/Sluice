...
trackers, wording — the row returns to ACTIVE-NOW only if the merged repair
is amended; the repair subsequently merged via PR #190 (921dd864). One NEW
row was registered during #189: e9
