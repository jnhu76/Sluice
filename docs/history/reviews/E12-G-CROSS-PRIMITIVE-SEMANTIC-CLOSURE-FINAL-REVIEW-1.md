...
| C2-F05 | P1 | `docs/history/reviews/E12-C-REVIEW.md` at HEAD `e75c0fe` retains BOTH the historical `PASS (corrective applied)` line AND the explicit `Await final E12-C migration data-race micro-review` next action; PR #13 only prepended a dated supersession notice | RESOLVED (history preserved) |
