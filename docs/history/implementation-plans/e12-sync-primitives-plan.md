...
> [`docs/history/closeout/e12-semaphore.md`](e12-semaphore.md) (policy register A1–A5, corrected
...
> and committed (see [`docs/history/closeout/e12-semaphore.md`](e12-semaphore.md) §14 As-Built);
...
> [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) (policy register M-H1–M-H4,
...
> [`docs/history/closeout/e10-waitnode-wait-queue.md`](e10-waitnode-wait-queue.md)). E11 is
> CLOSED at `7715808` (spec
> [`docs/history/closeout/e11-deadline-timer-wait.md`](e11-deadline-timer-wait.md); formal model
...
> [`docs/history/closeout/e12-semaphore.md`](e12-semaphore.md) §3.)
...
[`docs/history/closeout/e12-semaphore.md`](e12-semaphore.md) §5. (The grant-commit insertion
...
5. **On unlock with waiters:** **CLOSED — direct ownership handoff (M-H1).**
   ...
   AFTER ownership is committed. See [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md)
   §8.3 and §9.
...
8. **Fairness guarantee:** **CLOSED — FIFO + no barging (M-H2, M-H3, M-H4).**
   ...
   [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §2.
...
[`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §10. The seam classification
is now:
...
> [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §3.
...
* [`docs/history/closeout/e12-queue.md`](e12-queue.md) current semantic authority;
...
> [`docs/history/closeout/e12-cross-primitive-terminal-audit.md`](e12-cross-primitive-terminal-audit.md)
...
>   ([`docs/history/closeout/e12-condition.md`](e12-condition.md) C-H1); the Model A/B debate
>   is NOT reopened.
...
- **Correct invariant (simplified conservation law, §5.2):**
  ...
  [`docs/history/closeout/e12-semaphore.md`](e12-semaphore.md) §8 and modelled in
...
- **Correct invariant:** mutual exclusion (at most one owner); the ownership
  ...
  [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §14.
- **Minimum state dimensions:** `owner ∈ Fiber ∪ {NoOwner}` (NO redundant
  ...
  See [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §14.
- **Liveness:** NONE (safety-only model, matching Semaphore precedent).
- **Required negative models (11 total):** NEG-M1 through NEG-M11 as
  specified in [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §16. Each
...
6. A grant-bearing primitive needs to commit primitive resource state
   ...
   [`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §9.)
...
`MUTEX-HANDOFF-ONE` is specified in
[`docs/history/closeout/e12-async-mutex.md`](e12-async-mutex.md) §10. Classify:
...
- E11 insertion audit (style precedent for this document):
  [`docs/history/closeout/e11-arch-recon-audit.md`](e11-arch-recon-audit.md)
