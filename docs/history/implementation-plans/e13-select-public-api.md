...
`docs/history/implementation-plans/e13-select-production-architecture.md` §8). The variadic expands into a
...
(`docs/history/implementation-plans/e13-select-locking-and-publication.md`). Exposing it would invite
