...
| DC-13 authority conflict: capacity reservation ordered before validation under saturation | Superseded as stated (old vocabulary); the underlying behavior survives as a live conformance gap | SEM-03 precedence steps 4 vs 5–7 | #394 | Ledger A1 row: `submit_transaction` reserves a slot before range validation under saturation — GAP, owned by #394 |
