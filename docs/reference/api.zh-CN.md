...
`v0.0.1` 参考基线时的公开、准稳定 API。"准稳定"意味着删除或静默重新语义化会破坏使用者；视为在小版本间冻结，仅在有计划的弃用时更改。
...
当前同步架构见 `docs/architecture/async-synchronization.md`；E10–E12 closeout 保留为历史实现证据。
