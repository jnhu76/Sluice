------------------------------- MODULE E12QueueNegCommitAfterClose -------------------------------
(*
  NEG-QUEUE-5: CommitAfterClose. FastPushCommit drops the queueState = Open guard, allowing a producer commit into the ring after close linearizes.
  Single-rule difference from E12QueueClosed: the ONLY defect is in FastPushCommit.
  Expected first invariant violation: NoCommitAfterClose.
*)
