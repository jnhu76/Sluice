------------------------------- MODULE E12QueueNegPublishBeforeCommit -------------------------------
(*
  NEG-QUEUE-4: PublishBeforeCommit. ProducerGrantCommit increments wakeDispatched (publishes) but leaves the winner's completion Pending (not finalized before publication).
  Single-rule difference from E12Queue: the ONLY defect is in ProducerGrantCommit.
  Expected first invariant violation: NoPublishedPendingCompletion.
*)
