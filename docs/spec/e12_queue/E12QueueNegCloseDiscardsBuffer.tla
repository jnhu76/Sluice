------------------------------- MODULE E12QueueNegCloseDiscardsBuffer -------------------------------
(*
  NEG-QUEUE-6: CloseDiscardsBuffer. CloseLinearize clears the ring and releases all buffered items (discards them) instead of leaving them drainable.
  Single-rule difference from E12QueueClosed: the ONLY defect is in CloseLinearize.
  Expected first invariant violation: NoBufferedItemDiscardOnClose.
*)
