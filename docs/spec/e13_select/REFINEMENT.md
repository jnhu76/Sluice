...
| `wait_account_open_count`, `wait_account_close_count`, `timer_account_open_count`, `timer_account_close_count` (M) | none | PR #18 per-arm accounting; refines Central behaviour but adds no Central-visible state. |
