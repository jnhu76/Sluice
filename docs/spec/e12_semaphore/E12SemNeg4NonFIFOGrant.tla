------------------------------- MODULE E12SemNeg4NonFIFOGrant -------------------------------
(*
  NEG-SEM-4: NonFIFOGrant. ReleaseTransfer grants an eligible node that is NOT the FIFO head (requires >= 2 eligible waiters to be reachable).
  Single-rule difference from E12Semaphore: the ONLY defect is in ReleaseTransfer.
  Expected first invariant violation: InvFIFOGrant.
*)
