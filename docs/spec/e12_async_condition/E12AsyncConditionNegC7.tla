...
\* Destroy
\* ===========================================================================
\* NEG-C7: DestroyWithActiveWaiters — destroyed'=TRUE can fire even when fibers
\* are waiting on conditions (no queue-empty / no-waiter guard).
