...
> in the long `Current evidence` field above are historical. PR #78 completed
...
| Current evidence | `cancel.hpp:37-147`; `docs/api-reference.md:992-1005` (CancelProtection / CancelState / CancelGuard); conformance map (F/F row, audit issue #94). |
