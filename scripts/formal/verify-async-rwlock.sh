...
#                                         negative control; regenerated by
...
#
# Exit status: 0 iff the correct model passes AND every negative/reachability
# model produces the counterexample named by its cfg.
set -euo pipefail
...
# (regenerated from the positive model; see
# scripts/formal/gen-rwlock-neg-writer-revoke.py).
