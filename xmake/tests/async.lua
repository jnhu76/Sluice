...
sluice_one_file_test("async_completion_test", {includedirs = {"include"}})

-- FakeAsyncBackend tests (sluice-CORE-019). The deterministic test vehicle.
sluice_one_file_test("fake_backend_test", {includedirs = {"include"}})

-- Async "all" helpers tests (sluice-CORE-018). read_all/write_all over the fake.
sluice_one_file_test("async_op_helpers_test", {includedirs = {"include"}})

-- Async durability ops tests (sluice-CORE-018B, W4).
sluice_one_file_test("async_durability_test", {includedirs = {"include"}})

-- Async cancellation tests (sluice-CORE-021 spike).
sluice_one_file_test("async_cancel_test", {includedirs = {"include"}})
...
sluice_one_file_test("uring_backend_test", {includedirs = {"include"}})

-- ThreadPoolBackend tests (sluice-CORE-020A). Real blocking I/O on threads.
sluice_one_file_test("threadpool_backend_test", {includedirs = {"include"}})
...
sluice_one_file_test("cancel_token_test", {includedirs = {"include"}})
...
sluice_one_file_test("future_test", {includedirs = {"include"}})
...
sluice_one_file_test("group_test", {includedirs = {"include"}})
...
sluice_one_file_test("fiber_ctx_test", {includedirs = {"include"}})
...
sluice_one_file_test("evented_scheduler_test", {includedirs = {"include"}})
...
-- Gated to x86_64.
sluice_one_file_test("scheduler_ready_flag_test", {includedirs = {"include"}})
...
sluice_one_file_test("evented_future_test", {includedirs = {"include"}})
...
sluice_one_file_test("evented_group_test", {includedirs = {"include"}})
...
sluice_one_file_test("scheduler_progress_test", {includedirs = {"include"}})
...
-- Gated to x86_64.
sluice_one_file_test("multi_worker_test", {includedirs = {"include"}})
...
sluice_one_file_test("runnable_dup_publication_test", {includedirs = {"include"}})
...
sluice_one_file_test("runnable_steal_test", {includedirs = {"include"}})
...
sluice_one_file_test("wait_queue_test", {includedirs = {"include"}})
...
sluice_one_file_test("scheduler_wait_test", {includedirs = {"include"}})
...
sluice_one_file_test("wait_queue_external_wake_test", {includedirs = {"include"}})
...
sluice_one_file_test("wait_queue_resolution_authority_test", {includedirs = {"include"}})
...
sluice_one_file_test("wait_queue_unlink_topology_test", {includedirs = {"include"}})
...
sluice_one_file_test("e14_parity_test", {includedirs = {"include"}})
