...
| Generic C++ guidance conflicts with an Accepted ADR | `cpp-coding-standards` | skill invents its own precedence order | agent follows `AGENTS.md §3` authority chain and reports the conflict |
